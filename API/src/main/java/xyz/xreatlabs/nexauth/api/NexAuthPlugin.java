...
import xyz.xreatlabs.nexauth.api.event.EventTypes;
...
public interface NexAuthPlugin<P, S> {
     ...
     * @param clazz   The class the connector will be registered for. (e.g. {@link xyz.xreatlabs.nexauth.api.database.connector.MySQLDatabaseConnector})
