...
public interface ServerHandler<P, S> {
  ...
  /**
   * Gets the latest ping of the server, returns null if the server is not online. Can block if the
   * server has not yet been pinged.
   *
   ...
   * @throws xyz.xreatlabs.nexauth.api.event.exception.EventCancelledException If lobby choose event
   *     is cancelled
