...
public interface PlatformHandle<P, S> {
  ...
  /**
   * Moves the player to the specified location asynchronously and returns a CompletableFuture that
   * will be completed with an exception if an error occurs during the move.
   *
   * @param player the player to be moved
   * @param to the location to which the player should be moved
   * @return a CompletableFuture that will be completed with an exception if an error occurs during
   *     the move
   */
