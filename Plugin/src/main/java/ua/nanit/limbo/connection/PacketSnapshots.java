...
public final class PacketSnapshots {
  ...
  public PacketSnapshots(LimboServer server) {
    ...
    this.packetKnownPacks =
        PacketSnapshot.of(
            PacketKnownPacks.class,
            (version) -> {
              PacketKnownPacks packetKnownPacks = new PacketKnownPacks();

              packetKnownPacks.setKnownPacks(
                  List.of(
    ...
    this.packetUpdateTags =
        PacketSnapshot.of(
            PacketUpdateTags.class,
            (version) -> {
              PacketUpdateTags packetUpdateTags = new PacketUpdateTags();
              if (version.moreOrEqual(Version.V1_21_7)) {
                packetUpdateTags.setTags(
                    parseUpdateTags(server.getDimensionRegistry().getTags_1_21_7()));
              } else if (version.moreOrEqual(Version.V1_21_6)) {
                packetUpdateTags.setTags(
                    parseUpdateTags(server.getDimensionRegistry().getTags_1_21_6()));
              } else if (version.moreOrEqual(Version.V1_21_5)) {
                packetUpdateTags.setTags(
                    parseUpdateTags(server.getDimensionRegistry().getTags_1_21_5()));
              } else if (version.moreOrEqual(Version.V1_21_4)) {
                packetUpdateTags.setTags(
                    parseUpdateTags(server.getDimensionRegistry().getTags_1_21_4()));
              } else if (version.moreOrEqual(Version.V1_21_2)) {
                packetUpdateTags.setTags(
                    parseUpdateTags(server.getDimensionRegistry().getTags_1_21_2()));
              } else if (version.moreOrEqual(Version.V1_21)) {
                packetUpdateTags.setTags(
                    parseUpdateTags(server.getDimensionRegistry().getTags_1_21()));
              } else {
                packetUpdateTags.setTags(
                    parseUpdateTags(server.getDimensionRegistry().getTags_1_20_5()));
              }
    ...
    packetsRegistryData1_20_5 =
        createRegistryData(server, server.getDimensionRegistry().getCodec_1_20_5());
    packetsRegistryData1_21 =
        createRegistryData(server, server.getDimensionRegistry().getCodec_1_21());
    packetsRegistryData1_21_2 =
        createRegistryData(server, server.getDimensionRegistry().getCodec_1_21_2());
    packetsRegistryData1_21_4 =
        createRegistryData(server, server.getDimensionRegistry().getCodec_1_21_4());
    PACKETS_REGISTRY_DATA_1_21_5 =
        createRegistryData(server, server.getDimensionRegistry().getCodec_1_21_5());
    PACKETS_REGISTRY_DATA_1_21_6 =
        createRegistryData(server, server.getDimensionRegistry().getCodec_1_21_6());
    PACKETS_REGISTRY_DATA_1_21_7 =
        createRegistryData(server, server.getDimensionRegistry().getCodec_1_21_7());
    ...
    for (int chunkX = chunkXOffset - chunkEdgeSize;
        chunkX <= chunkXOffset + chunkEdgeSize;
        ++chunkX) {
      for (int chunkZ = chunkZOffset - chunkEdgeSize;
          chunkZ <= chunkZOffset + chunkEdgeSize;
          ++chunkZ) {
  ...
  private static List<PacketSnapshot> createRegistryData(
      LimboServer server, CompoundBinaryTag dimensionTag) {
    ...
    for (String registryType : dimensionTag.keySet()) {
      ...
      registryData.setMetadataWriter(
          (message, version) -> {
