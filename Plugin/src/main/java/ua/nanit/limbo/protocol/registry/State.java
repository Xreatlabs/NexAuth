...
public enum State {
  HANDSHAKING(0) {
    {
      serverBound.register(PacketHandshake::new, map(0x00, Version.getMin(), Version.getMax()));
    }
  },
  STATUS(1) {
    {
      serverBound.register(PacketStatusRequest::new, map(0x00, Version.getMin(), Version.getMax()));
      serverBound.register(PacketStatusPing::new, map(0x01, Version.getMin(), Version.getMax()));
      clientBound.register(
          PacketStatusResponse::new, map(0x00, Version.getMin(), Version.getMax()));
      clientBound.register(PacketStatusPing::new, map(0x01, Version.getMin(), Version.getMax()));
    }
  },
  LOGIN(2) {
    {
      serverBound.register(PacketLoginStart::new, map(0x00, Version.getMin(), Version.getMax()));
      serverBound.register(
          PacketLoginPluginResponse::new, map(0x02, Version.getMin(), Version.getMax()));
      serverBound.register(PacketLoginAcknowledged::new, map(0x03, V1_20_2, Version.getMax()));
      clientBound.register(PacketDisconnect::new, map(0x00, Version.getMin(), Version.getMax()));
      clientBound.register(PacketLoginSuccess::new, map(0x02, Version.getMin(), Version.getMax()));
      clientBound.register(
          PacketLoginPluginRequest::new, map(0x04, Version.getMin(), Version.getMax()));
    }
  },
  CONFIGURATION(3) {
    {
      ...
      clientBound.register(
          PacketDisconnect::new, map(0x01, V1_20_2, V1_20_3), map(0x02, V1_20_5, Version.getMax()));
      clientBound.register(
          PacketFinishConfiguration::new,
          map(0x02, V1_20_2, V1_20_3),
          map(0x03, V1_20_5, Version.getMax()));
      clientBound.register(
          PacketKeepAlive::new, map(0x03, V1_20_2, V1_20_3), map(0x04, V1_20_5, Version.getMax()));
      clientBound.register(PacketKnownPacks::new, map(0x0E, V1_20_5, Version.getMax()));
      clientBound.register(PacketUpdateTags::new, map(0x0D, V1_20_5, Version.getMax()));
      clientBound.register(
      ...
      serverBound.register(
          PacketKeepAlive::new, map(0x03, V1_20_2, V1_20_3), map(0x04, V1_20_5, Version.getMax()));
      serverBound.register(PacketKnownPacks::new, map(0x07, V1_20_5, Version.getMax()));
    }
  },
  PLAY(4) {
    {
      ...
      clientBound.register(
          PacketPlayerPositionAndLook::new,
  ...
  public static class ProtocolMappings {
    ...
    private Collection<Version> getRange(Mapping mapping) {
      ...
      if (curr == from) return Collections.singletonList(from);
