...
public final class DimensionRegistry {
  ...
  private Dimension getLegacyDimension(String def) {
    switch (def) {
      ...
      default:
        {
          Log.warning(
              "Undefined dimension type: '%s'. Using 'minecraft:overworld' as default", def);
  ...
  private Dimension getModernDimension(String def, CompoundBinaryTag tag) {
    ...
    CompoundBinaryTag overWorld =
        (CompoundBinaryTag) ((CompoundBinaryTag) dimensions.get(0)).get("element");
