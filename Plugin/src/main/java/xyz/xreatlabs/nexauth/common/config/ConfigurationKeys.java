...
public class ConfigurationKeys {
  ...
  public static final ConfigurationKey<List<String>> LIMBO =
      new ConfigurationKey<>(
          ...
          "The authentication servers/worlds, players should be sent to, when not authenticated. On"
              + " Paper, players will be spawned on the world spawn. THIS SERVERS MUST BE"
              + " REGISTERED IN THE PROXY CONFIG. IN CASE OF PAPER, THE WORLDS MUST EXIST.",
          ConfigurateHelper::getStringList);
...
""",
          (helper, key) ->
              ProfileConflictResolutionStrategy.valueOf(helper.getString(key).toUpperCase())
                  .name() // Sanity check
          );
  ...
  public static final ConfigurationKey<Integer> MILLISECONDS_TO_EXPIRE_LOGIN_ATTEMPTS =
      new ConfigurationKey<>(
          ...
          10000,
          "Time to reset login attempts. The amount of time the player should have waited for their"
              + " login attempts to expire. On every rejoin, login attempts are reset.",
          ConfigurateHelper::getInt);
...
""",
  ...
  public static final ConfigurationKey<Boolean> HIDE_PLAYER_INVENTORY =
      new ConfigurationKey<>(
...
""",
  ...
  public static final ConfigurationKey<Integer> MINIMUM_USERNAME_LENGTH =
      new ConfigurationKey<>(
          ...
          -1,
          "The minimum length the player's name can have. Only applies to new players, set to 0 or"
              + " lower to disable.",
          ConfigurateHelper::getInt);
  ...
  public static final ConfigurationKey<Long> SESSION_TIMEOUT =
      new ConfigurationKey<>(
          "session-timeout",
          0L,
          "Defines a time in seconds after a player's session expires. Default value is one week"
              + " (604800 seconds). Set to zero or less to disable sessions.",
  ...
  public static final ConfigurationKey<Boolean> PING_SERVERS =
      new ConfigurationKey<>(
          "ping-servers",
          false,
          "!!THIS OPTION IS IRRELEVANT WHEN USING PAPER!! Should we ping servers to check if they"
              + " are online, and get their player count? If you disable this, the pinging servers"
              + " message will still appear in the console, even though the servers will not be"
              + " pinged.",
          ConfigurateHelper::getBoolean);
  ...
  public static final ConfigurationKey<Boolean> REMEMBER_LAST_SERVER =
      new ConfigurationKey<>(
          ...
          false,
          "Should we remember the last server/world a player was on? This is not recommended for"
              + " large networks.",
          ConfigurateHelper::getBoolean);
  ...
  public static final ConfigurationKey<Boolean> FALLBACK =
      new ConfigurationKey<>(
          "fallback",
          false,
          "!!THIS OPTION IS IRRELEVANT WHEN USING PAPER!! Should we fallback players to lobby"
              + " servers if the server they are on shutdowns? If set to false, they will be"
              + " kicked.",
          ConfigurateHelper::getBoolean);
  ...
  public static final ConfigurationKey<Integer> TOTP_DELAY =
      new ConfigurationKey<>(
          "totp.delay",
          1000,
          "The delay in milliseconds until player is given a map to scan the QR code. Increase this"
              + " value if the map disappears too quickly.",
          ConfigurateHelper::getInt);
  ...
  public static final ConfigurationKey<String> MAIL_PASSWORD =
      new ConfigurationKey<>(
          "mail.password",
          "password",
          "The password used to login to the SMTP server. We highly recommend you use a unique"
              + " one-time password for this.",
          ConfigurateHelper::getString);
...
""",
  ...
  public static final ConfigurationKey<String> LIMBO_PORT_RANGE =
      new ConfigurationKey<>(
          "limbo-port-range",
          "30000-40000",
          "!!THIS OPTION IS IRRELEVANT WHEN USING PAPER!! Defines port(s) that limbo server can be"
              + " bounded to.",
          ConfigurateHelper::getString);

  public static final ConfigurationKey<String> FAILURE_POLICY_MODE =
      new ConfigurationKey<>(
          "failure-policy.mode",
          "HARD_FAIL",
  ...
  public static final ConfigurationKey<Boolean> STRICT_MAIN_THREAD_IO_CHECK =
      new ConfigurationKey<>(
          "strict-main-thread-io-check",
          false,
          "When enabled, NexAuth throws an exception whenever an IO operation is reported on the"
              + " main thread.",
          ConfigurateHelper::getBoolean);

  public static final ConfigurationKey<Integer> DATABASE_TRANSIENT_RETRIES =
      new ConfigurationKey<>(
          "database.transient-retries",
          0,
          "How many times to retry transient database connection failures before applying failure"
              + " policy.",
          ConfigurateHelper::getInt);

  public static final ConfigurationKey<Integer> DATABASE_TRANSIENT_RETRY_DELAY_MS =
      new ConfigurationKey<>(
  ...
  public static final ConfigurationKey<Boolean> SECURITY_LOGIN_BACKOFF_ENABLED =
      new ConfigurationKey<>(
  ...
  public static final ConfigurationKey<Integer> SECURITY_LOGIN_BACKOFF_INITIAL_MS =
      new ConfigurationKey<>(
  ...
  public static final ConfigurationKey<Integer> SECURITY_LOGIN_BACKOFF_MAX_MS =
      new ConfigurationKey<>(
  ...
  public static final ConfigurationKey<Integer> SECURITY_LOGIN_BACKOFF_MULTIPLIER =
      new ConfigurationKey<>(
  ...
  public static final ConfigurationKey<Boolean> SECURITY_LOGIN_LOCKOUT_ENABLED =
      new ConfigurationKey<>(
  ...
  public static final ConfigurationKey<Integer> SECURITY_LOGIN_LOCKOUT_THRESHOLD =
      new ConfigurationKey<>(
  ...
  public static final ConfigurationKey<Integer> SECURITY_LOGIN_LOCKOUT_DURATION_MS =
      new ConfigurationKey<>(
  ...
  public static final ConfigurationKey<Boolean> SECURITY_TOTP_ATTEMPT_LIMIT_ENABLED =
      new ConfigurationKey<>(
  ...
  public static final ConfigurationKey<Integer> SECURITY_TOTP_MAX_ATTEMPTS =
      new ConfigurationKey<>(
  ...
  public static final ConfigurationKey<Integer> SECURITY_TOTP_ATTEMPT_WINDOW_MS =
      new ConfigurationKey<>(
