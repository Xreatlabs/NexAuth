  ...
  public void sendEmail(String email, String subject, String content) {
    try {
      ...
      mail.setAuthentication(
          config.get(ConfigurationKeys.MAIL_USERNAME), config.get(ConfigurationKeys.MAIL_PASSWORD));
      mail.addTo(email);
      mail.setFrom(
          config.get(ConfigurationKeys.MAIL_EMAIL), config.get(ConfigurationKeys.MAIL_SENDER));
