...
package xyz.xreatlabs.nexauth.common.image.protocolize.packet;
...
import xyz.xreatlabs.nexauth.common.image.protocolize.MapData;
...
public class MapDataPacket extends AbstractPacket {
  ...
  public void read(ByteBuf byteBuf, PacketDirection packetDirection, int protocol) {
    ...
    iconData =
        new IconData[(protocol < MINECRAFT_1_17 || trackingPosition) ? readVarInt(byteBuf) : 0];
