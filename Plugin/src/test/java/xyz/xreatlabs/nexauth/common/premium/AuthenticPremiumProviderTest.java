...
class AuthenticPremiumProviderTest {
        ...
        providerWithFetchers(
            name -> {
              throw new PremiumException(
                  PremiumException.Issue.SERVER_EXCEPTION, "Mojang unavailable");
            },
            name -> null,
            name -> null);
  ...
  @SafeVarargs
  private static AuthenticPremiumProvider providerWithFetchers(
      ThrowableFunction<String, PremiumUser, PremiumException>... fetchers) throws Exception {
    ...
    var configuredFetchers =
        (List<ThrowableFunction<String, PremiumUser, PremiumException>>) field.get(provider);
  ...
  private static final class TestPlugin extends AuthenticNexAuth<Object, Object> {
    ...
    private static final PlatformHandle<Object, Object> PLATFORM =
        new PlatformHandle<>() {
          @Override
          ...
          @Override
          public void kick(Object player, net.kyori.adventure.text.Component reason) {}
          ...
          public ProxyData getProxyData() {
            return new ProxyData("test", List.of(), List.of(), List.of(), List.of());
          }
        };
    ...
    public File getDataFolder() {
      return new File("build/test-nexauth");
    }
